        ...
        <main>
            <div class="wrapper_main">
                ...
                <form class="align_left" method="post" enctype="multipart/form-data" id="manage">
                    ...
                    <p>商品名　　：
                    <input id="name_form" type="text" name="product_name" pattern="\S+" title="商品名を入力してください">
                    <span id="name_check_msg" class="red_text small_text">　商品名を入力してください</span></p>
                    <p>価格　　　：
                    <input id="price_form" type="text" name="price" pattern="^[0-9０-９]+$" title="0以上の整数を入力してください">
                    <span id="price_check_msg" class="red_text small_text">　0以上の整数を入力してください</span></p>
                    <p>在庫数　　：
                    <input id="stock_form" type="text" name="stock_qty" pattern="^[0-9０-９]+$" title="0以上の整数を入力してください">
                    <span id="stock_check_msg" class="red_text small_text">　0以上の整数を入力してください</span></p>
                    <p>商品画像　：
                    <input id="file_btn" class="file_btn" type="file" name="upload_image" accept="image/png, image/jpeg" required>
